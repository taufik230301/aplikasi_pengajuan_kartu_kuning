...
class M_loker extends CI_Model
{
    ...
    {
        $hasil = $this->db->query("SELECT id_loker, nama_perusahaan, judul, loker.deskripsi, posisi, jumlah_rekrut, salary, batas_akhir FROM loker JOIN perusahaan_detail ON loker.id_perusahaan = perusahaan_detail.id_perusahaan_detail WHERE id_perusahaan='$id_user'");
        return $hasil;
    }
