...
class M_loker extends CI_Model
{
    ...
    public function get_all_loker($id_user)
    {
        $hasil = $this->db->query("SELECT * FROM loker JOIN perusahaan_detail ON loker.id_perusahaan = perusahaan_detail.id_perusahaan_detail WHERE id_perusahaan='$id_user'");
        return $hasil;
    }
