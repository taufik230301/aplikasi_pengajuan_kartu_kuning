...
class M_status_verifikasi extends CI_Model
{
    ...
    public function update_status_verifikasi_perusahaan($status_verifikasi, $id_perusahaan)
    {
        $this->db->trans_start();

        $this->db->query("UPDATE perusahaan_detail SET id_status_verifikasi='$status_verifikasi' WHERE id_perusahaan_detail='$id_perusahaan'");
